...
OMonsterMinotaur::OMonsterMinotaur()
{
}
...
HRESULT OMonsterMinotaur::Init(string key, int pos)
{
...
void OMonsterMinotaur::Release()
{
}

void OMonsterMinotaur::Update()
{
	Anim();
...
void OMonsterMinotaur::Render()
{
	MonsterBase::Render();
}

void OMonsterMinotaur::Anim()
{
	count++;
...
bool OMonsterMinotaur::SearchTarget()
{
